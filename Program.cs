...
//это вариант по индексу

(int[,],int) RandomArrayCreation(int rows , int columns , int minRandom , int maxRandom)//вставил на всякий случай возможность изменения рандомности чисел
{
